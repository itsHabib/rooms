...
import remote as r
r.LAB=r.READY/'lab/ci-runs-v3';r.LAB.mkdir(exist_ok=True)
r.STORE=r.READY/'lab/go-ci-v2';r.BASE='1c0ba652dfc62ae4687d431581d96ece59b314cb'
...
out,rec=r.run('prepare',[str(r.BIN),'base-create','--image',str(r.IMAGE),'--toolstore',str(r.STORE),'--cpus','2','--memory','4096','--repo',r.REPO,'--base-sha',r.BASE,'--warm','{ '+warm+'; } > /tmp/ci-warm.log 2>&1','--json'],timeout=900)
