.PHONY: check fmt fmt-check lint test test-rehearsal test-swarm e2e build release clean
...
check: fmt-check lint test test-rehearsal test-swarm
...
test-swarm:
	python3 -m unittest discover -s examples/swarm -p 'test_*.py'
