...
9. **Cloud experiment ideas** — [`experiments/cloud-experiment-ideas-2026-09-14.md`](experiments/cloud-experiment-ideas-2026-09-14.md). Backlog of real-KVM tests: density, a shared Nix store, fork-the-world agent branching, rooms that travel, agents inside rooms.
